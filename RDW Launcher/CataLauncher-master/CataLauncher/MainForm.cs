...
namespace CataLauncher
{
    public partial class MainForm : Form
    {
        ...
        private void playButtonPictureBox_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show(this, "Die WoW.exe konnte nicht gefunden werden!", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        ...
        private void MainForm_Load(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show(ex.Message, "Red-Dragon-WoW Launcher", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        ...
        private void UpdateProgressbar(int percent, long bytesReceived, long totalBytesToReceive)
        {
            ...
            string progress = String.Format("Download Prozess: {0} / {1}", received, total);

...
class wow_studio_teleporter : public CreatureScript
{
    public:
        ...
        { 
            ...
            player->ADD_GOSSIP_ITEM(2, "H\303\274gel der Klingenhauer",              GOSSIP_SENDER_MAIN,  115);
            player->ADD_GOSSIP_ITEM(2, "Kral der Klingenhauer",                      GOSSIP_SENDER_MAIN,  116);
		...
		if (action == 7)
            ...
            player->ADD_GOSSIP_ITEM(2, "Burg Utgarde",                         GOSSIP_SENDER_MAIN,  72);
		...
		if (action == 9)
		{
			...
			if (action == 72)
			{
				player->CLOSE_GOSSIP_MENU(); player->TeleportTo(571,   1224.961304f,  -4863.529785f,    41.248772f, 0.364413f);
			}
			if (action == 73)
			{
			...
			if (action == 115)
			{
				player->CLOSE_GOSSIP_MENU(); player->TeleportTo(1,     -4656.191895f, -2519.638916f,    81.118088f, 0.000000f);
			}
			if (action == 116)
			{
				player->CLOSE_GOSSIP_MENU(); player->TeleportTo(1,     -4467.008301f, -1670.505371f,    81.878777f, 0.000000f);
			}
			return true;
		}       
};

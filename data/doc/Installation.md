...
* OR download from here: [mega link](https://mega.nz/#F!pJIylKRL!Qb7AI7pMsugji5TMnXQJuQ)
...
Move to `azerothcore/apps/db_assembler/`.

run the `db_assembler.sh` script:

`bash ./db_assembler.sh`

it will generate the databases under the `/env/dist/sql` directory of your azerothcore sources directory.
